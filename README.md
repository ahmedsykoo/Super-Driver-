...
The app currently supports the package IDs used for Uber Driver, DiDi Captain and inDrive in the native service. The actual package ID presented by a particular regional/app release may differ, so unsupported packages are ignored rather than pretending to have detected a trip.
